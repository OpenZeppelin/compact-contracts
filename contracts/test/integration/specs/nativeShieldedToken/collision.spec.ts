 ...
 * extension's guarantee: reusing a nonce for the same (value, recipient)
 * reproduces the commitment, which is rejected.
 *
 ...
 */
describe('Collision — duplicate commitment rejection', () => {
