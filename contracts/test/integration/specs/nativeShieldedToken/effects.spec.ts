 ...
 * effects". A mint of `amount` under the contract's domain records
 ...
 */
describe('Effects — shieldedMints reconstruction', () => {
  ...
  it('should record shieldedMints[domain] == minted amount in the tx effects', async () => {
    const amount = 777n;
  ...
  it('should reconstruct the derived-nonce mint amount from public effects too', async () => {
    const amount = 321n;
