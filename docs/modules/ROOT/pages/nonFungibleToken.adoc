:nonFungibleToken-guide: xref:nonFungibleToken.adoc[NonFungibleToken guide]
...
import "./node_modules/@openzeppelin-compact/tokens/NonFungibleToken" prefix NonFungibleToken_;
...
export circuit isApprovalForAll(owner: Either<ZswapCoinPublicKey, ContractAddress>, operator: Either<ZswapCoinPublicKey, ContractAddress>): Boolean {
  return NonFungibleToken_isApprovalForAll(owner, operator);
}
