...
constructor(
  ...
  MINTER_ROLE = persistent_hash<Bytes<32>>(pad(32, "MINTER_ROLE"));
...
constructor(
  ...
  FungibleToken_initialize(name, symbol, decimals);
  MINTER_ROLE = persistent_hash<Bytes<32>>(pad(32, "MINTER_ROLE"));
  BURNER_ROLE = persistent_hash<Bytes<32>>(pad(32, "BURNER_ROLE"));
  AccessControl__grantRole(MINTER_ROLE, minter);
...
constructor(
  ...
  AccessControl__grantRole(AccessControl_DEFAULT_ADMIN_ROLE, left<ZswapCoinPublicKey,ContractAddress>(own_public_key()));
}
