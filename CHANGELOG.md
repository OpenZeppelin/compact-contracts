...
- Rename the shielded multisig presets by capability: `ShieldedMultiSig` → `ShieldedProposalMultisig`, `ShieldedMultiSigV2` → `ShieldedStatelessMultisig`, and `ShieldedMultiSigV3` → `NativeShieldedTokenMultisig`. (#XXX)
